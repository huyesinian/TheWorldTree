...
layui.define(['form', 'table'], function (exports) {
  ...
  Class.prototype.render = function () {
    ...
    colArr.splice(0, 0, {
      align: 'left',
      width: 50,
      title: openTable ? '': '<i class="opTable-i-table-open ' + getOpenAllClickClass(options.elem) + ' " ' + KEY_STATUS + '="off"  title="(展开|关闭)全部"></i>',
          ...
          .click(function () {
            ...
            if (openNetwork) {
              loadNetwork();
                ...
                console.log(openTable.itemData);
  ...
  //加载组件所需样式
  layui.link('../lib/opTable/opTable.css?v=1' + VERSION, function () {
